<?php
    ...
    if(isset($_POST['user_id']) &&
        ...
        $queryTeacher->bindValue(":teacher_id", $user_id);
        ...
        $queryStudent->bindValue(":student_id", $receiver_userid);
        ...
        $query->bindValue(":to_username", $student_username);
        $query->bindValue(":from_username", $teacher_username);
