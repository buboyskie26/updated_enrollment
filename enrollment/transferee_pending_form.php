...
<?php 
    ...
    if (isset($_POST['transferee_pending_form_btn'])) {
        ...
        $wasSuccess = $pending->PendingTransfereeFormSubmit(
...
<!-- <form action="index.php?q=subject" class="form-horizontal well" method="post" > -->
	...
	<div class="col-md-8"><h2>Pending Pre-Registration (Transferee)</h2></div>
	<div class="col-md-4"><label>Academic Year: <?php echo $currentYear; ?> <span>(<?php echo $current_semester; ?>)</span> </label></div>
		<table class="table">
			...
			<td></td>
				<td colspan="5">	
					<button class="btn btn-success btn-lg" name="transferee_pending_form_btn" type="submit">Submit</button>
				</td>
			</tr>
		</table>
	</div>
