        ...
        if(isset($_GET['id'])){
            ...
            if($sql->rowCount() > 0){
                ...
                $get_available_section = $con->prepare("SELECT 
                    course_tertiary_id, capacity, program_section
                    ...
                    ORDER BY course_tertiary_id DESC
                    LIMIT 1");

                // $program_id = 0;
                $get_available_section->bindValue(":program_id", $program_id);
                $get_available_section->bindValue(":course_level", 1);
                ...
                $get_available_section->bindValue(":school_year_id", $current_school_year_id);
                $get_available_section->execute();

                $section_output = "N/A";

                $available_program_section = "";
                ...
                if($get_available_section->rowCount() > 0){
                    ...
                    $available_program_section = $available_section['program_section'];
            ...
            ?>
                <div class="row col-md-12">
                    ...
                    <div class="col-lg-10 offset-md-1">
                        <h4 class="text-center text-muted mb-3">Tertiary Pre-Enrollment</h4>
                        <div class="card mb-4">
                            <div class="card-body">
                            <div class="row">
                                <div class="col-sm-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">1st Year</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                    ...
                    <div class="col-lg-10 offset-md-1">
                        ...
                        <div style="margin-left: 6px;" class="row">
                            ...
                            <div style="padding: 0px; font-weight:500;" class="col-md-8">
                                <p class="mb-0 text-primary"><?php echo $available_program_section;?></p>
                            </div>
                        </div>
                    ...
                    <div class="text-center">
                        <button onclick='confirmPendingValidationTertiaryNew("<?php echo $firstname ?>", "<?php echo $lastname ?>", "<?php echo $middle_name ?>", "<?php echo $password ?>", "<?php echo $program_id ?>", "<?php echo $civil_status ?>", "<?php echo $nationality ?>", "<?php echo $contact_number ?>", "<?php echo $birthday ?>", "<?php echo $age ?>", "<?php echo $guardian_name ?>", "<?php echo $guardian_contact_number ?>", "<?php echo $sex ?>", "<?php echo $student_status ?>", "<?php echo $program_section ?>", "<?php echo $pending_enrollees_id ?>", "<?php echo $address; ?>", "<?php echo $lrn; ?>", "<?php echo $type; ?>")' name='confirm_validation_btn' class='btn btn-success btn-sm'>Confirm</button>
                ...
                // alert('qwe');
                    ...
                    function confirmPendingValidationTertiaryNew(firstname, lastname, middle_name, password,
                        program_id, civil_status, nationality, contact_number, birthday, age,
                        guardian_name, guardian_contact_number, sex, student_status,
                        program_section,pending_enrollees_id, address, lrn, type){

                            // alert('confirm');
                        // console.log('click');
                        $.ajax({
                            url: '../ajax/enrollee/registrar_confirm_tertiary_pending.php',
                            type: 'POST',
                            data: {
