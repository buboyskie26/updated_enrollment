        ...
        ?>
            <div class="row col-md-12">
                                ...
                                <?php
                                    ...
                                    if($sql->rowCount() > 0){
                                        ...
                                        while($row = $sql->fetch(PDO::FETCH_ASSOC)){
                                            ...
                                            echo "
                                                <option value='".$row['course_id']."'>".$row['program_section']." $status</option>
                                            ";
                                        }
                                    }
                                ?>
                ...
                <div class="text-center">
                    <button onclick='confirmPendingValidation("<?php echo $firstname ?>", "<?php echo $lastname ?>", "<?php echo $middle_name ?>", "<?php echo $password ?>", "<?php echo $program_id ?>", "<?php echo $civil_status ?>", "<?php echo $nationality ?>", "<?php echo $contact_number ?>", "<?php echo $birthday ?>", "<?php echo $age ?>", "<?php echo $guardian_name ?>", "<?php echo $guardian_contact_number ?>", "<?php echo $sex ?>", "<?php echo $student_status ?>", "<?php echo $program_section ?>", "<?php echo $pending_enrollees_id ?>", "<?php echo $address; ?>", "<?php echo $lrn; ?>")' name='confirm_validation_btn'
                        class='btn btn-success btn-sm'>Confirm Request</button>

                    <button class="btn btn-outline-danger btn-sm">Reject Request</button>
                </div>
