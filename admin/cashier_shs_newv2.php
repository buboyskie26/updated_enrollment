...
<div class="row col-md-12">
    <h4 class="text-center">New Enrollees SHS (Cashier) (SY: <?php echo $current_school_year_term;?>-<?php echo $current_school_year_period;?> Semester)</h4>
                ...
                <?php
                    ...
                    if($new_enrollee->rowCount() > 0){
                        ...
                        while($row = $new_enrollee->fetch(PDO::FETCH_ASSOC)){
                            ...
                            $url = "../enrollees/view_student_new_enrollment_cashier.php?id=";
   ...
   function confirmValidation(course_id, student_id) {
    $.ajax({
        ...
        success: function(response) {
            ...
            alert(response);
            location.reload();
            // window.location.href="http://localhost/dcbt/admin/cashier_shs_new.php";
        },
