<?php 
    ...
    if(isset($_POST['student_username'])
        ...
        $oldEnrollees = new OldEnrollees($con, $enrol);

        $recommendedList = $enrol->GetRecommendedOldStudentForNextSemester($student_username);
        ...
        if(sizeof($recommendedList) > 0){
            ...
            // Check if already been inserted to avoid duplication.
            // Check Make sure that the number of loop is the number of student_subject insertion.  
            ...
            foreach ($recommendedList as $key => $value) {
                ...
                # code...
                $sql = $con->prepare("INSERT INTO student_subject (student_id, subject_id,
            ...
            if($enrolledSuccess == true){
                ...
                $update_success = $oldEnrollees->UpdateStudentStatus($student_username);
            ...
            //    else{
            //         echo "Updating student status went wrong";
            //    }
            }else{
                echo "inserting student_subject went wrong";
            }
            // Todo: Add to the enrolled_students.

            // Chec kif student was new_enrolle
            if($enrolledSuccess 
                && $enrol->CheckIfStudentIsNewEnrollee($student_username) == true){
