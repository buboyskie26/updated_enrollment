<?php 
    ...
    require_once('../../admin/classes/CashierSHSNavigationMenu.php');
    require_once('../../admin/classes/AdminUser.php');
   
    $adminLoggedIn = isset($_SESSION["cashierLoggedIn"]) 
...
<body>
    ...
    <div id="pageContainer">
        ...
        <!-- <div id="sideNavContainer" style="display: none;"> -->
            <?php
                $nav = new CashierSHSNavigationMenu($con, $adminLoggedInObj);
                echo $nav->create();
            ?>
        </div>
