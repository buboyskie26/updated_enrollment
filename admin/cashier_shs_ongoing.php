...
<div class="row col-md-12">
    <h4 class="text-center">Ongoing Enrollees SHS (Cashier) (SY: <?php echo $current_school_year_term;?>-<?php echo $current_school_year_period;?> Semester)</h4>
...
<script>
   ...
   function confirmValidation(course_id, student_id) {
    $.ajax({
        url: './ajax/enrollee/cashier_confirm_os_enrollee.php', // replace with your PHP script URL
        type: 'POST',
        data: {
