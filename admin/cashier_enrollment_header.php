<?php
    ...
    require_once('../../admin/classes/CashierNavigationMenu.php');
    require_once('../../admin/classes/CashierEnrollmentNavigationMenu.php');
    ...
    $cashierLoggedInObj = new AdminUser($con, $cashierLoggedIn);
?>
...
<head>
    ...
    <title>Enrollment DCBT (CASHIER)</title>
    ...
    <div id="pageContainer">
        <div id="mastHeadContainer">
            ...
            <div class="rightIcons">
                ...
                <?php
                    echo ButtonProvider::createAdminProfileNavigationButton($con, $cashierLoggedIn);
                ?>
            </div>
        </div>
        ...
        <!-- <div id="sideNavContainer" style="display: none;"> -->
            <?php
                $nav = new CashierEnrollmentNavigationMenu($con, $cashierLoggedIn);
                echo $nav->create();
            ?>
        </div>
